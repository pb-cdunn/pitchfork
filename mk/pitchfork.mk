...
ifeq ($(OPSYS),Darwin)
	@echo "export DYLD_LIBRARY_PATH=$(DYLD_LIBRARY_PATH):$$DYLD_LIBRARY_PATH PATH=$(PATH):$$PATH" > "$(PREFIX)/setup-env.sh"
else
	@echo "export LD_LIBRARY_PATH=$(LD_LIBRARY_PATH):$$PATH PATH=$(PATH)" > "$(PREFIX)/setup-env.sh"
endif
